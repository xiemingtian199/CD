    ...
    "方图": [
        {
            "purpose": "首屏产品识别",
            "main": "含氟口腔含漱液",
            "sub": "用产品核心属性做首屏点击点，真实瓶身与包装正面展示，突出规格和护理定位。",
            "visual": "电商主图构图，产品居中偏大，浅色干净背景，少量文字在右侧或上方。",
        },
        {
            "purpose": "场景痛点引入",
            "main": "饭后口腔不清爽？",
            "sub": "用消费者日常痛点引导点击，场景表达使用时机，不出现疗效承诺。",
            "visual": "洗漱台或办公室洗手区场景，产品放在前景，背景有人物生活痕迹但不露夸张表情。",
        },
        {
            "purpose": "规格与SKU说明",
            "main": "1瓶/2瓶/3瓶可选",
            "sub": "把购买选择说清楚，减少用户在SKU和价格上的疑虑，避免低价误导。",
            "visual": "产品瓶身与SKU组合平铺展示，配简洁规格信息块，画面像清晰的电商规格图。",
        },
        {
            "purpose": "使用步骤说明",
            "main": "含漱护理更方便",
            "sub": "把买点落在使用便利性上，用步骤图表达护理流程，强调阅读说明书和合理使用。",
            "visual": "三步流程信息图：取用、含漱、清洁收纳，图标简洁，产品在左侧或底部。",
        },
        {
            "purpose": "资质与信任背书",
            "main": "资质信息清楚可查",
            "sub": "用信任买点降低决策顾虑，展示真实资质、标签、说明书信息，不使用专家或机构背书。",
            "visual": "产品与资质文件局部排版，文件内容虚化或用占位信息，整体专业可信。",
        },
    ],
    "长图": [
        {
